...
Shader "SineVFX/PrototypeGridHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar2 = TriplanarSampling2( _Albedo, ase_worldPos, normalWS, 1.0, _Tiling, 1.0, 0 );
				
				float3 switchResult22 = (((isFrontFace>0)?(float3(0,0,1)):(float3(0,0,-1))));
				
				surfaceDescription.Albedo = ( _ColorTint * triplanar2 ).rgb;
				surfaceDescription.Normal = switchResult22;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar2 = TriplanarSampling2( _Albedo, ase_worldPos, ase_worldNormal, 1.0, _Tiling, 1.0, 0 );
		...
		Pass
		{
				...
				)
			{
				...
				SmoothSurfaceDescription surfaceDescription = (SmoothSurfaceDescription)0;
				float3 switchResult22 = (((ase_vface>0)?(float3(0,0,1)):(float3(0,0,-1))));
...
WireConnection;24;7;8;0
ASEEND*/
//CHKSM=2C59768112213F8651E499812BF1A37296496608