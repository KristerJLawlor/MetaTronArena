...
Shader "SineVFX/ForceFieldAndShieldEffects/ForceFieldBasicTriplanarHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC) : SV_Target
			{
				...
				float clampResult406 = clamp( ( 1.0 - dotResult1 ) , 0.0 , 1.0 );
				...
				#endif
				float clampResult17 = clamp( max( pow( clampResult406 , _MaskFresnelExp ) , staticSwitch330 ) , 0.0 , 1.0 );
				...
				#else
				float staticSwitch385 = packedInput.ase_texcoord5.xyz.y;
				#endif
				...
				#else
				float4 staticSwitch336 = temp_cast_4;
				#endif
		...
		Pass
		{
					...
					)
			{
				...
				float staticSwitch385 = ( FinalWorldPosition102.y / ase_objectScale.y );
				#else
				float staticSwitch385 = packedInput.ase_texcoord8.xyz.y;
				#endif
				float temp_output_109_0 = abs( ( (0.0 + (staticSwitch385 - 0.0) * (1.0 - 0.0) / (_MaskAppearLocalYRamap - 0.0)) + _MaskAppearLocalYAdd ) );
				#ifdef _MASKAPPEARINVERT_ON
				float staticSwitch118 = ( 1.0 - temp_output_109_0 );
...
/*ASEBEGIN
Version=18934
1920;0;1920;1019;3995.864;1942.236;1.211183;True;False
...
Node;AmplifyShaderEditor.WorldNormalVector;8;-552.8963,429.2237;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ClampOpNode;406;85.93604,144.6051;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;6;221.1042,237.224;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;404;1908.597,-334.2962;Inherit;False;Constant;_Float1;Float 1;43;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;362;1443.2,-155.4331;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
WireConnection;397;1;334;0
WireConnection;397;2;362;0
WireConnection;397;6;341;0
ASEEND*/
//CHKSM=09D79544330B4DD7A3032D6E996DE053CC567690