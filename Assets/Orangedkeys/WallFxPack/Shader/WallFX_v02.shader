	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord1 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_0 )) + ( SAMPLE_TEXTURE2D_LOD( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask, 0.0 ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 fetchOpaqueVal43 = ASEHDSampleSceneColor(ase_grabScreenPosNorm.xy, 0.0, GetInverseCurrentExposureMultiplier());
				...
				float2 texCoord1 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_3 )) + ( SAMPLE_TEXTURE2D( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
				float clampResult24 = clamp( pow( saferPower27 , 5.0 ) , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord1 = packedInput.ase_texcoord.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_0 )) + ( SAMPLE_TEXTURE2D( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
				float clampResult24 = clamp( pow( saferPower27 , 5.0 ) , 0.0 , 1.0 );
				float temp_output_36_0 = ( 1.0 - clampResult24 );
				float temp_output_62_0 = ( 1.0 - packedInput.ase_color.b );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord1 = inputMesh.uv1.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_0 )) + ( SAMPLE_TEXTURE2D_LOD( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask, 0.0 ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
				float clampResult24 = clamp( pow( saferPower27 , 5.0 ) , 0.0 , 1.0 );
				float lerpResult19 = lerp( 0.0 , inputMesh.ase_color.g , ( clampResult24 * ( -2.0 * _StretchingAnime ) ));
				float4 appendResult21 = (float4(0.0 , lerpResult19 , 0.0 , 0.0));
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 texCoord1 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_3 )) + ( SAMPLE_TEXTURE2D( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
				float clampResult24 = clamp( pow( saferPower27 , 5.0 ) , 0.0 , 1.0 );
				float temp_output_36_0 = ( 1.0 - clampResult24 );
				float3 lerpResult40 = lerp( ( temp_output_57_0 + ( localMyCustomExpression80 * _EmissiveMult ) ) , ( pow( desaturateVar54 , 1.0 ) + ( localMyCustomExpression80 * _WallColorMult ) ) , pow( temp_output_36_0 , 10.0 ));
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord1 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + ( (( _AnimatedOpening )?( ( float2( 1,1 ) * sin( mulTime69 ) ) ):( temp_cast_0 )) + ( SAMPLE_TEXTURE2D( _DistortionMask, sampler_DistortionMask, uv2_DistortionMask ).r * _MaskDistortion ) );
				float saferPower27 = abs( texCoord1.y );
				float clampResult24 = clamp( pow( saferPower27 , 5.0 ) , 0.0 , 1.0 );
				float temp_output_36_0 = ( 1.0 - clampResult24 );
				float temp_output_62_0 = ( 1.0 - packedInput.ase_color.b );
...
/*ASEBEGIN
Version=18935
-2560;0;2560;1379;4219.459;399.5085;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;68;-3081.099,310.1051;Inherit;False;Property;_SpeedAnimatedMode;Speed (AnimatedMode);7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;69;-2839.298,416.8052;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-3102.813,-162.2752;Inherit;False;Property;_WallOpening;WallOpening;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;71;-2661.298,415.8052;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;4;-2760.009,182.1396;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2754.51,782.6395;Inherit;False;Property;_MaskDistortion;MaskDistortion;1;0;Create;True;0;0;0;False;0;False;0.25;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;93;-2468.813,-153.2752;Inherit;False;Property;_AnimatedOpening;AnimatedOpening;12;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1658.359,698.3321;Inherit;False;Constant;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;-2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-1788.258,951.9791;Inherit;False;Property;_StretchingAnime;StretchingAnime;8;0;Create;True;0;0;0;False;0;False;1;-0.5;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-612.8772,24.24809;Inherit;False;Property;_FrameEmissive;FrameEmissive;10;0;Create;True;0;0;0;False;0;False;0.15;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-374.877,83.99596;Inherit;False;Constant;_Float3;Float 3;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;75;-156.8824,-1.50209;Inherit;False;Property;_DisplayFrame;Display Frame;9;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;43;-815.0121,-889.1075;Inherit;False;Global;_GrabScreen2;Grab Screen 2;1;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-1228.152,-129.9839;Inherit;False;Constant;_Hue;Hue;6;0;Create;True;0;0;0;False;0;False;0;180;-180;180;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;39;-1208.775,-443.9203;Inherit;False;Property;_MainColor;MainColor;2;0;Create;True;0;0;0;False;0;False;0.9323065,0.3368019,0.131792,0;1,0.4002926,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-988.2797,20.93154;Inherit;False;Property;_EmissiveMult;EmissiveMult;3;0;Create;True;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-221.7047,-839.1017;Inherit;False;Property;_OutlinesMult;OutlinesMult;6;0;Create;True;0;0;0;False;0;False;1;1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;164.8669,-1108.425;Inherit;False;Property;_WallOutlineColorMult;WallOutlineColorMult;5;0;Create;True;0;0;0;False;0;False;0.02;0.1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-728.1649,-723.1846;Inherit;False;Property;_WallColorMult;WallColorMult;4;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A05E2E05965A7ED22B24968C260EBD6ACBF5190E