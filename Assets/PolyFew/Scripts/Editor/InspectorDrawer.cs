...
#region Draw Tolerance Spheres Settings
                    ...
                    for (int a = 0; a < dataContainer.toleranceSpheres.Count; a++)
                    {
                        ...
                        // Happens when a prefab is edited in prefab mode and exit to normal scene
                        // All the items in the tolerance sphere get null
                        if (dataContainer.toleranceSpheres[a] == null)
                        {
