...
Shader "SciFI_HDRP/HologramTriplanarHDRP"
{
	Properties
	{
		...
		[ASEEnd][HDR]_Color("Color", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNdotV28 = dot( normalWS, V );
		...
		Pass
		{
					...
					)
			{
				...
				float4 lerpResult42 = lerp( lerpResult40 , tex2D( _Texture, ( float4( panner32, 0.0 , 0.0 ) + temp_output_21_0 ).rg ) , break29.z);
				float3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float fresnelNdotV28 = dot( ase_worldNormal, V );
				float fresnelNode28 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV28, _Power ) );
				float clampResult38 = clamp( ( 1.0 - fresnelNode28 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch41 = clampResult38;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 break14 = ( packedInput.ase_texcoord7.xyz * _NoiseTiling );
				float2 appendResult17 = (float2(break14.y , break14.z));
				float2 panner19 = ( 1.0 * _Time.y * float2( 0.03,0.05 ) + appendResult17);
				float2 uv_Noise = packedInput.ase_texcoord8.xy * _Noise_ST.xy + _Noise_ST.zw;
				float4 temp_output_21_0 = ( tex2D( _Noise, uv_Noise ) * _NoisePower );
				float3 break29 = abs( packedInput.ase_normal );
				float4 lerpResult37 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture, ( float4( panner19, 0.0 , 0.0 ) + temp_output_21_0 ).rg ) , break29.x);
				float2 appendResult20 = (float2(break14.x , break14.z));
...
/*ASEBEGIN
Version=18912
346;73;921;597;808.7086;223.4122;1.206745;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-3285.502,-375.349;Inherit;False;Property;_NoiseTiling;NoiseTiling;6;0;Create;True;0;0;0;False;0;False;7;7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-2482.456,-770.121;Float;False;Property;_NoisePower;NoisePower;4;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;15;-2601.795,-975.2828;Inherit;True;Property;_Noise;Noise;1;0;Create;True;0;0;0;False;0;False;-1;None;1dbcddf7c0c736f4d84ec53ff8243eb7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-1727.946,228.1116;Float;False;Property;_Scale;Scale;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1726.946,307.1112;Float;False;Property;_Power;Power;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;35;-1757.708,-685.084;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;0872c3bcf8503f74c802ba0f0a5e7d08;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;41;-876.0363,217.3266;Float;False;Property;_Invert;Invert;5;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;46;-357.386,-33.95324;Inherit;False;Property;_Color;Color;7;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EA7E4D1F80CE6F0283B292EBDBE73E348360A728