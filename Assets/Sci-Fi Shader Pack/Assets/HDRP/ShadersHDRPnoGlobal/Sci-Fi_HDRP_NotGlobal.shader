...
Shader "SciFI_HDRP/NotGlobal/Sci-FiHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack126 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _NormalPower );
				unpack126.z = lerp( 1, unpack126.z, saturate(_NormalPower) );
				
				float2 temp_cast_1 = (_DissolveTiling).xx;
				float2 texCoord16 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord16);
				...
				float2 texCoord58 = packedInput.ase_texcoord5.xy * temp_cast_2 + float2( 0,0 );
				float2 panner64 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord58);
				...
				float2 texCoord60 = packedInput.ase_texcoord5.xy * temp_cast_3 + float2( 0,0 );
				float2 panner67 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord60);
				...
				surfaceDescription.Normal = unpack126;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_1 = (_DissolveTiling).xx;
				float2 texCoord16 = packedInput.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord16);
				float temp_output_33_0 = ( 1.0 - tex2D( _Noises, panner20 ).r );
				float temp_output_27_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float temp_output_37_0 = ( -0.3 + temp_output_18_0 );
				...
				float4 lerpResult80 = lerp( ( _DissolveColor * ( 1.0 - step( temp_output_33_0 , ( temp_output_27_0 + _DissolveColorPower ) ) ) ) , lerpResult66 , lerpResult78);
				float2 temp_cast_2 = (_FirstTextureTiling).xx;
				float2 texCoord58 = packedInput.ase_texcoord.xy * temp_cast_2 + float2( 0,0 );
				float2 panner64 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord58);
				float4 tex2DNode75 = tex2D( _Noises, panner64 );
				float clampResult73 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult83 = lerp( tex2DNode75.g , 0.0 , clampResult73);
				float4 lerpResult84 = lerp( lerpResult80 , _FirstTextureColor , lerpResult83);
				float2 temp_cast_3 = (_SecondTextureTiling).xx;
				float2 texCoord60 = packedInput.ase_texcoord.xy * temp_cast_3 + float2( 0,0 );
				float2 panner67 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord60);
				float4 tex2DNode77 = tex2D( _Noises, panner67 );
				float clampResult74 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult82 = lerp( tex2DNode77.b , 0.0 , clampResult74);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord1.xy * temp_cast_0 + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord16);
				float temp_output_33_0 = ( 1.0 - tex2D( _Noises, panner20 ).r );
				float temp_output_27_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult55 = clamp( step( temp_output_33_0 , ( temp_output_27_0 + 0.1 ) ) , 0.0 , 1.0 );
				...
				float2 texCoord58 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
				float2 panner64 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord58);
				float4 tex2DNode75 = tex2D( _Noises, panner64 );
				float clampResult73 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult112 = lerp( tex2DNode75.g , 1.0 , clampResult73);
				float2 temp_cast_2 = (_SecondTextureTiling).xx;
				float2 texCoord60 = packedInput.ase_texcoord1.xy * temp_cast_2 + float2( 0,0 );
				float2 panner67 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord60);
				float4 tex2DNode77 = tex2D( _Noises, panner67 );
				float clampResult74 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult117 = lerp( tex2DNode77.b , 1.0 , clampResult74);
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode99 = tex2D( _Albedo, uv_Albedo );
				float2 temp_cast_0 = (_DissolveTiling).xx;
				float2 texCoord16 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord16);
				float temp_output_33_0 = ( 1.0 - tex2D( _Noises, panner20 ).r );
				float temp_output_27_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult55 = clamp( step( temp_output_33_0 , ( temp_output_27_0 + 0.1 ) ) , 0.0 , 1.0 );
				...
				float lerpResult119 = lerp( clampResult55 , 1.0 , clampResult72);
				float2 temp_cast_1 = (_FirstTextureTiling).xx;
				float2 texCoord58 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 panner64 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord58);
				float4 tex2DNode75 = tex2D( _Noises, panner64 );
				float clampResult73 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult112 = lerp( tex2DNode75.g , 1.0 , clampResult73);
				float2 temp_cast_2 = (_SecondTextureTiling).xx;
				float2 texCoord60 = packedInput.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				float2 panner67 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord60);
				float4 tex2DNode77 = tex2D( _Noises, panner67 );
				float clampResult74 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult117 = lerp( tex2DNode77.b , 1.0 , clampResult74);
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_1 = (_DissolveTiling).xx;
				float2 texCoord16 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord16);
				float temp_output_33_0 = ( 1.0 - tex2D( _Noises, panner20 ).r );
				float temp_output_27_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float temp_output_37_0 = ( -0.3 + temp_output_18_0 );
				...
				float4 lerpResult80 = lerp( ( _DissolveColor * ( 1.0 - step( temp_output_33_0 , ( temp_output_27_0 + _DissolveColorPower ) ) ) ) , lerpResult66 , lerpResult78);
				float2 temp_cast_2 = (_FirstTextureTiling).xx;
				float2 texCoord58 = packedInput.ase_texcoord7.xy * temp_cast_2 + float2( 0,0 );
				float2 panner64 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord58);
				float4 tex2DNode75 = tex2D( _Noises, panner64 );
				float clampResult73 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult83 = lerp( tex2DNode75.g , 0.0 , clampResult73);
				float4 lerpResult84 = lerp( lerpResult80 , _FirstTextureColor , lerpResult83);
				float2 temp_cast_3 = (_SecondTextureTiling).xx;
				float2 texCoord60 = packedInput.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float2 panner67 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord60);
				float4 tex2DNode77 = tex2D( _Noises, panner67 );
				float clampResult74 = clamp( abs( ( ( vpY19 + temp_output_22_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult82 = lerp( tex2DNode77.b , 0.0 , clampResult74);
				float4 lerpResult90 = lerp( lerpResult84 , _SecondTextureColor , lerpResult82);
				float2 uv_Emission = packedInput.ase_texcoord7.xy * _Emission_ST.xy + _Emission_ST.zw;
				float4 tex2DNode89 = tex2D( _Emission, uv_Emission );
				float4 clampResult116 = clamp( ( tex2DNode89 / lerpResult90 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float grayscale120 = Luminance(clampResult116.rgb);
				float4 lerpResult137 = lerp( lerpResult90 , ( tex2DNode89 * _EmissionColor ) , grayscale120);
...
/*ASEBEGIN
Version=18912
173;75;1066;597;4529.537;-321.3034;1.496809;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-3756.617,1188.542;Float;False;Property;_ObjectHigh;ObjectHigh;9;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-3755.421,1106.347;Float;False;Property;_ObjectLow;ObjectLow;11;0;Create;True;0;0;0;False;0;False;-0.5;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-3879.472,1020.926;Float;False;Property;_ShaderSciFi;_ShaderSciFi;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-3804.888,-1425.95;Float;False;Property;_DissolveTiling;DissolveTiling;13;0;Create;True;0;0;0;False;0;False;18;18;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-3375.027,-58.13031;Float;False;Constant;_Float0;Float 0;12;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-3483.571,-1185.126;Float;False;Property;_DissolvePower;DissolvePower;15;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;24;-3043.311,-1470.889;Inherit;True;Property;_Noises;Noises;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;-3191.709,1414.809;Float;False;Constant;_Const8;Const8;27;0;Create;True;0;0;0;False;0;False;-0.3;-0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-2958.656,-1065.335;Float;False;Constant;_OpacityPowerConst;OpacityPowerConst;10;0;Create;True;0;0;0;False;0;False;0.1;0.12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-2848.427,-483.4833;Float;False;Constant;_Const6;Const6;16;0;Create;True;0;0;0;False;0;False;0.4;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-2614.445,1173.258;Float;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-2653.23,572.9603;Float;False;Property;_SecondTextureHight;SecondTextureHight;24;0;Create;True;0;0;0;False;0;False;1.79;1.79;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;36;-2815.371,395.6974;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-2671.726,42.42072;Float;False;Property;_FirstTextureHight;FirstTextureHight;20;0;Create;True;0;0;0;False;0;False;1.1;1.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-2976.046,-1270.862;Float;False;Property;_DissolveColorPower;DissolveColorPower;16;0;Create;True;0;0;0;False;0;False;0.02;-0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-2698.458,-426.0233;Float;False;Property;_DissolveSquareScale;DissolveSquareScale;17;0;Create;True;0;0;0;False;0;False;1;1;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;41;-2610.205,411.4416;Inherit;False;19;vpY;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-2595.997,222.1008;Float;False;Property;_SecondTextureTiling;SecondTextureTiling;26;0;Create;True;0;0;0;False;0;False;24;24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-2381.12,614.2459;Float;False;Property;_SecondTextureScale;SecondTextureScale;25;0;Create;True;0;0;0;False;0;False;2.55;2.55;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;45;-2290.557,1004.031;Inherit;False;19;vpY;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-2390.615,86.70612;Float;False;Property;_FirstTextureScale;FirstTextureScale;21;0;Create;True;0;0;0;False;0;False;1.69;1.69;0.1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-2459.456,-281.4573;Float;False;Property;_FirstTextureTiling;FirstTextureTiling;22;0;Create;True;0;0;0;False;0;False;14;14;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;47;-2392.953,-426.3513;Float;False;Property;_DissolveSquarePower;DissolveSquarePower;18;0;Create;True;0;0;0;False;0;False;1;0.84;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;57;-1926.114,1010.729;Float;False;Property;_VertexColor;VertexColor;8;2;[HDR];[Gamma];Create;True;0;0;0;False;0;False;22.36352,0,0,0;47.93726,4.015687,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;65;-2265.991,-1505.496;Float;False;Property;_DissolveColor;DissolveColor;14;2;[HDR];[Gamma];Create;True;0;0;0;False;0;False;1.41976,33.89676,0,0;14.55686,0,95.87451,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;75;-1688.183,-327.8113;Inherit;True;Property;_FirstTexture;FirstTexture;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;24;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;81;-1054.063,-479.7064;Float;False;Property;_FirstTextureColor;FirstTextureColor;19;2;[HDR];[Gamma];Create;True;0;0;0;False;0;False;0,8.154376,91.32901,0;0,9.035295,95.87451,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-2345.917,825.1319;Float;False;Property;_OpacityScale;OpacityScale;29;0;Create;True;0;0;0;False;0;False;0.14;0.14;0.01;0.9;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;85;-872.3322,-280.5883;Float;False;Property;_SecondTextureColor;SecondTextureColor;23;2;[HDR];[Gamma];Create;True;0;0;0;False;0;False;0,2.038594,22.83225,0;0,9.035295,95.87451,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;86;-2528.16,1690.776;Inherit;False;19;vpY;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2546.303,-853.4984;Float;False;Property;_DarkAreaScale;DarkAreaScale;27;0;Create;True;0;0;0;False;0;False;0.34;0.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-2703.654,1932.815;Float;False;Constant;_Const1;Const1;5;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-2288.438,-744.2043;Float;False;Property;_DarkAreaPower;DarkAreaPower;28;0;Create;True;0;0;0;False;0;False;3.24;3.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;89;-719.0093,-680.1544;Inherit;True;Property;_Emission;Emission;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;96;-2288.012,1564.552;Float;False;Constant;_Const2;Const2;5;0;Create;True;0;0;0;False;0;False;0.02;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-2028.688,837.9442;Float;False;Property;_OpacityPower;OpacityPower;30;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;100;-1532.411,-1328.148;Float;False;Property;_AlbedoColor;AlbedoColor;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;99;-1573.349,-1518.202;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-997.8392,-1083.103;Inherit;False;Property;_NormalPower;NormalPower;31;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;110;-553.0985,-865.1653;Inherit;False;Property;_EmissionColor;EmissionColor;7;2;[HDR];[Gamma];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;126;-782.092,-1088.404;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-472.5064,-177.2663;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;-467.5479,-93.53027;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;134;-480.8749,-15.42352;Inherit;True;Property;_AO;AO;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;4;0,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-23;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;7;0,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;-18;0;True;-19;1;0;True;-20;0;True;-21;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;0;True;-22;True;0;True;-28;False;True;1;LightMode=TransparentBackface;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;6;0,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;8;0,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-23;False;False;False;False;False;False;False;False;False;True;True;0;False;-1;255;False;-1;255;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;10;0,0;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;-18;0;True;-19;1;0;True;-20;0;True;-21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;True;True;0;True;-3;255;False;-1;255;True;-4;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-22;True;0;True;-27;False;True;1;LightMode=Forward;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=675BBFEC1C0A1CFF3639A6E10F583C02AE8F59CD