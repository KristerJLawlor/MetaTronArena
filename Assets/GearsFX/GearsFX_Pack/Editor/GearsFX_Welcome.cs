...
namespace Orangedkeys.GearsFX
{
    public class WelcomeGearsFX : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/GearsFX_Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(WelcomeGearsFX), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Orangedkeys/GearsFX_Pack/Resources/GearsFX_Icon.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''GEARS FX PACK'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
