...
namespace Orangedkeys.HOLOFX
{
    public class WelcomeHoloFX : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/HoloFX_Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(WelcomeHoloFX), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/HOLO_FX_PACK/Resources/holofx.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''HOLO FX PACK'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
